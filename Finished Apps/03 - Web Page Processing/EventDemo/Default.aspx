        ...
        <table style="width: 404px">
            <tr>
                ...
                <td style="width: 238px">
                    <asp:TextBox ID="NameTextBox" runat="server" Width="146px" AutoPostBack="True" OnTextChanged="NameTextBox_TextChanged"></asp:TextBox></td>
            </tr>
            <tr>
                ...
                <td style="width: 238px; height: 24px">
                    <asp:TextBox ID="TelNumTextBox" runat="server" Width="146px" AutoPostBack="True" OnTextChanged="TelNumTextBox_TextChanged"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 57px; height: 24px;">
                    <asp:Label ID="RegionLabel" runat="server" Text="Region:"></asp:Label></td>
                <td style="width: 238px; height: 24px;">
                    <asp:DropDownList ID="RegionList" runat="server" Width="152px" AutoPostBack="True" OnSelectedIndexChanged="RegionList_SelectedIndexChanged">
                    </asp:DropDownList></td>
            </tr>
            <tr>
                <td style="width: 57px; height: 24px">
                ...
                <td style="width: 238px; height: 24px">
                    <asp:DropDownList ID="CountryList" runat="server" Width="152px" AutoPostBack="True">
                    </asp:DropDownList></td>
            </tr>
        </table>
